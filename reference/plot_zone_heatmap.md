...
``` r
plot_zone_heatmap(firstName, lastName, startDate, endDate, playerIndex = 1)
```
...
A table with all players that match the input name, and a heatmap plot
of the specified time period data
...
#> ℹ Data updated: 2026-05-28 18:27:04 UTC
#> # A tibble: 6 × 11
